...
# http://qa.stratio.com/repository/releases/com/stratio/jdbc/stratio-crossdata-jdbc4/2.14.3-3e6ad32/stratio-crossdata-jdbc4-2.14.3-3e6ad32.jar
RUN apk add --update wget && \
    ...
    mvn dependency:get -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.14.3-3e6ad32 -DremoteRepositories=http://sodio.stratio.com/repository/public/ -Dtransitive=false && \
    mv /root/.m2/repository/com/stratio/jdbc/stratio-crossdata-jdbc4/2.14.3-3e6ad32/stratio-crossdata-jdbc4-2.14.3-3e6ad32.jar /app/source/bin/lib/stratio-crossdata-jdbc4-2.14.3-3e6ad32.jar && \
    mvn install:install-file -Dfile=/app/source/bin/lib/stratio-crossdata-jdbc4-2.14.3-3e6ad32.jar -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.14.3-3e6ad32 -Dpackaging=jar
