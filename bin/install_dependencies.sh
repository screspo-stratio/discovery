...
mvn dependency:copy -Dartifact=com.stratio.jdbc:stratio-crossdata-jdbc4:2.11.2-12aa007 -DoutputDirectory=./bin/lib/
mvn install:install-file -Dfile=./bin/lib/stratio-crossdata-jdbc4-2.11.2-12aa007.jar -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.11.2-12aa007 -Dpackaging=jar
