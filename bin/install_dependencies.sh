...
mvn dependency:copy -Dartifact=com.stratio.jdbc:stratio-crossdata-jdbc4:2.14.3-3e6ad32 -DoutputDirectory=./bin/lib/
mvn install:install-file -Dfile=./bin/lib/stratio-crossdata-jdbc4-2.14.3-3e6ad32.jar -DgroupId=com.stratio.jdbc -DartifactId=stratio-crossdata-jdbc4 -Dversion=2.14.3-3e6ad32 -Dpackaging=jar
